...
- 2026-09-23: Added `quizzes/quiz-01-mock-04.html` and separate key for a timed check of rotated D–H translation columns and grasp-pose transfer. No source files moved or renamed; canonical notes already cover both underlying rules.
