...
\noindent\textbf{Sources.} \texttt{resources/lecture-01-04-linear-and-nonlinear-programming.pdf} (Lectures 1--4) and\\
\texttt{resources/introduction-to-linear-programming.pdf}. These notes explain and consolidate the methods; they do not reproduce every numerical tableau or worked calculation in the slides.
...
\end{enumerate}
The sign convention in a tableau must be kept consistent; never mix a minimization reduced-cost test with a maximization one. The ratio test is what prevents a step from leaving the feasible region.
...
\source{\texttt{resources/lecture-01-04-linear-and-nonlinear-programming.pdf}, slides 60--69.}
...
\source{\texttt{resources/lecture-01-04-linear-and-nonlinear-programming.pdf}, slides 81--90.}
...
\begin{itemize}
 ...
 \item Can I build the symmetric dual and use complementary slackness to infer zeros/tight constraints?
